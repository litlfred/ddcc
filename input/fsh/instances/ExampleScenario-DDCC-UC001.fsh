...
* process[+].title="Paper Recording of Vaccination Event"
...
* step[=].process[=].step[=].operation.title = "Gives vaccination event information"
* step[=].process[=].step[=].operation.initiator = "Vaccinator"
...
* step[=].process[=].step[=].operation.initiator = "DataEntryPerssonel"
* step[=].process[=].step[=].operation.receivor = "DataEntryPerssonel"

* step[=].process[=].step[+].number = "1.4"
* step[=].process[=].step[=].operation.title = "Signs or stamps vaccine record"
* step[=].process[=].step[=].operation.initiator = "DataEntryPersonnel"
* step[=].process[=].step[=].operation.receivor = "DataEntryPersonnnel"


* step[=].process[=].step[+].number = "1.5"
* step[=].process[=].step[=].operation.title = "Gives hand stamped or signed vaccination record"
