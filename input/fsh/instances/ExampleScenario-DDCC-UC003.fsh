...
Instance: ExampleScenario-DDCC-UC004
InstanceOf: ActorDefinition
Description: """Online Digital: Online digital	A guideline-based vaccine administration is recorded using an online secure Digital Health Solution which updates the content in real time."""
...
* process[+].title="Online Digial Recording of Vaccination Event"
